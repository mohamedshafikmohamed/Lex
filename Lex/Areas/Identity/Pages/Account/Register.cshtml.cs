...
namespace Lex.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Application_user { UserName = Input.Email, Email = Input.Email, EmailConfirmed = true, name =Input.Name,phone=Input.phone };
